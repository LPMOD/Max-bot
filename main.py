...
def create_credentials_template():
    ...
    template = """# LPMOD Free Fire Bot Credentials
...
def load_credentials_from_file(filename="NoTmeowL.txt"):
    """
    ...
    try:
        ...
        fields = {
            ...
            2: {
                ...
                6: "iG:[C][B][FF0000] @LPMOD",  # Nickname
                7: 330,                   # Rank
                8: 1000,                  # Field 8
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]LPMOD [FFFF00]!!
"""
...
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]LPMOD
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@LPMOD
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ WELCOME TO LPMOD BOT ░░▒▓█
[FFFF00]»»————-　★　————-««
[FFFFFF]⚡ BOT POWERED BY:[FF0000]X³
[FFFFFF]🎯 STATUS: [FFFF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT: [FFFF00]@LPMOD
[FFFF00]»»————-　★　————-««
...
"""
                                ...
                                credentials = load_credentials_from_file("NoTmeowL.txt")
                                if not credentials:
...
"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[B][C][FFC0CB]bot खरीदने या बनवाने के लिए संपर्क करें ?

मोबाइल पैनल नों रूट और रूट दोनों अवेलेबल सस्ते प्राइस में?

ईमोट वेबसाइट ईमोट एप और all source code available ?

All of this is available, just contact me on WhatsApp only !

[b][i][FFC0CB]youtube: LPMOD[/b]

[b][c][FFC0CB]subcribe: my_channel[FFFFFF]
 
[b][i][FFA500]telegram: @LPMOD[/b]

[b][c][FFA500] only WhatsApp number: 626226293[A52A2A]
 
Enjoy the bot my friend.......

[C][B][0000FF] Created by THE MAX
Modified by - LPMOD
"""
...
[9400D3]M A D E B Y [FF0000]LPMOD
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@LPMOD666
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
async def MaiiiinE():
    ...
    print("📁 Loading credentials from NoTmeowL.txt...")
    credentials = load_credentials_from_file("NoTmeowL.txt")
    
    if not credentials:
        print("❌ Failed to load credentials!")
        print("💡 Please create NoTmeowL.txt with your UID and password")
